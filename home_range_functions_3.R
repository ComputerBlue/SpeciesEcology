...
# spread_habitat_overlapping_coreareas <-function(locus, raster, raster2, spread_prob, Nhabitat){
#   # raster2 is the raster describing where individuals DO NOT TRAVERSE
#   stopRule2 <- function(landscape) sum(landscape) > Nhabitat
#   result <- spread(raster, loci = locus, spread_prob, 0, NULL, 1e8, 4, iterations = 3, id = TRUE, returnIndices = TRUE)
#   return(result)
# }
